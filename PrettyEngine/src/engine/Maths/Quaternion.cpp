...
namespace PrettyEngine {
	...
	Quaternion& Quaternion::SetXYZ(const Vector3 & vec)
	{
		x = vec.x;
		y = vec.y;
		z = vec.z;
	...
	const Quaternion Quaternion::Rotation(const Vector3& unitVec0, const Vector3& unitVec1)
	{
		...
		cosHalfAngleX2 = sqrt((2.0f * (1.0f + unitVec0.DotProduct(unitVec1))));
		recipCosHalfAngleX2 = (1.0f / cosHalfAngleX2);
		return Quaternion((unitVec0.CrossProduct(unitVec1) * recipCosHalfAngleX2), (cosHalfAngleX2 * 0.5f));
	}
